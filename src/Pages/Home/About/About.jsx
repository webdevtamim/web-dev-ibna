...
const About = () => {
    ...
    return (
        <section id="about">
            <div className="grid grid-cols-2 max-w-[1200px] mx-auto px-5 gap-4 pt-20">
                <div className="pr-5 space-y-4 pt-2">
                    ...
                    <div className="flex items-center gap-5 justify-center">
                        <a href="https://www.fiverr.com/ibnasina16" target="_blank"><img className="hover:scale-110 duration-300" src={fiverr} alt="Fiverr-logo" /></a>
                        <a href="https://www.upwork.com/freelancers/~012cb95e8213067fd5" target="_blank"><img className="w-28 hover:scale-110 duration-300" src={upwork} alt="Upwork-logo" /></a>
                    </div>
                </div>
                <div className="space-y-6 p-2">
                    <h3 className="text-3xl font-extrabold text-headning-color">WEBSITE DESIGNER & DEVELOPER.</h3>
                    <div className="text-[rgb(80,102,144)] leading-[28px] pb-2">
                    ...
                    <button className="bg-[#282828] text-white hover:bg-btn-hover font-semibold text-[15px] tracking-[1px] py-[14px] px-12 rounded leading-[15px] duration-300 active:scale-x-95">HIRE ME</button>
                </div>
            </div>
        </section>
    );
