            ...
            <div className="flex-col-reverse flex lg:grid grid-cols-2 max-w-[1200px] mx-auto px-5 lg:gap-2 gap-10 items-center md:py-20 pt-16 pb-10">
                <div className="lg:space-y-5 space-y-3">
                    ...
                    <div className="text-center lg:text-left">
                        <button
                            onClick={handleId}
                            className="bg-[#282828] text-white hover:bg-btn-hover font-semibold text-[15px] tracking-[1px] py-[14px] px-7 rounded leading-[15px] duration-300 active:scale-x-95"
                        >GET STARTED</button>
                    </div>
                </div>
                <div>
