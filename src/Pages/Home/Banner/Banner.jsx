...
const Banner = () => {
    return (
        <section id="Home" className="bg-bg-color">
            <div className="flex-col-reverse flex lg:grid grid-cols-2 max-w-[1200px] mx-auto px-5 gap-2 items-center py-20">
                <div className="space-y-5">
                    <h2 className="lg:text-5xl text-3xl font-extrabold text-headning-color leading-[55px] text-center lg:text-left">LET'S BUILD YOUR WEBSITE TOGETHER.</h2>
                    <p className="text-lg max-w-[500px] text-[#222] pb-5 text-center lg:text-left">
                ...
                <div>
                    <img data-aos="fade-zoom-in" className="border-[10px] border-[#EAF2FC] rounded-xl max-w-[75%] lg:max-w-full mx-auto lg:mx-0" src={bannerImg} alt="Banner" />
                </div>
            </div>
            <div>
