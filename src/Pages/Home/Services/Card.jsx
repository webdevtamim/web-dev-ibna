...
const Card = () => {
    return (
        <section id='services' className='pt-20 mb-20 md:mb-0 px-5'>
            <div className='max-w-[520px] mx-auto'>
                <div>
                    <img data-aos="fade-zoom-in" className="border-[10px] border-[#EAF2FC] rounded-xl" src={card} alt="" />
                </div>
                <h3 className="md:text-xl text-lg text-center font-bold text-headning-color tracking-[0.5px] pt-5">I'M A VERIFIED WEB DEVELOPER & FREELANCER <br /> BY BANGLADESH GOVERNMENT.</h3>
            </div>
            <div className='-mt-24 overflow-hidden max-h-64 hidden md:block'>
